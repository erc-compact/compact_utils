...
class Tiling(object):
    ...
    """
    def __init__(self, coordinates, beam_shape, tiling_meta, overlap, core_radius, half_light_radius, half_mass_radius, central_freq):
        """
        constructor of the Tiling class.
    ...
    def plot_tiling(self, filename, overlap = None, index = False, scope = 1.,
        ...
        plotPackedBeam(self.coordinates, angle, widthH, widthV,
            self.beam_shape.bore_sight.equatorial, self.meta, self.core_radius, self.half_light_radius, self.half_mass_radius, self.central_freq,
            fileName=filename, index = index, scope = scope,
...
def generate_nbeams_tiling(beam_shape, beam_num, overlap, method, tilingShape, core_radius, half_light_radius, half_mass_radius, central_freq,
    ...
    tiling_obj = Tiling(tiling_coordinates, beam_shape, tiling_meta, overlap, core_radius, half_light_radius, half_mass_radius, central_freq)
